...
private slots:
    ...
    void Const_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Const_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::CConstHeader(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void Checksum_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CChecksum(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC8_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC8(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC16_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC16(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC32_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC32(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void CRC64_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CCRC64(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    ...
    void XOr_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CXOR(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_RSA_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_RSA_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_RSA_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_RSA_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_RSA_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_RSA_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_RSA_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_RSA_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CRSA(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_AES_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_AES_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_AES_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_AES_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_AES_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_AES_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_AES_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_AES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CAES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_DES_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_DES_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_DES_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_DES_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_DES_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_DES_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_DES_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_DES_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CDES(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_TwoFish_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_TwoFish_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_TwoFish_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_TwoFish_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_TwoFish_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_TwoFish_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_TwoFish_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_TwoFish_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Encryption::CTwoFish(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_DEFLATE_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_DEFLATE_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_DEFLATE_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_DEFLATE_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_DEFLATE_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_DEFLATE_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_DEFLATE_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_DEFLATE_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CDEFLATE(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_Huffman_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_Huffman_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_Huffman_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_Huffman_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_Huffman_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_Huffman_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_Huffman_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_Huffman_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CHuffman(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_Arithmetic_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_Arithmetic_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_Arithmetic_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_Arithmetic_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_Arithmetic_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_Arithmetic_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_Arithmetic_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_Arithmetic_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CArithmetic(),new HeaderBuilder::ValidationHeader::CHash()));
    }
    void Hash_JPEG_ConstHeader(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::CConstHeader()));
    }
    void Hash_JPEG_Checksum(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CChecksum()));
    }
    void Hash_JPEG_CRC8(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CCRC8()));
    }
    void Hash_JPEG_CRC16(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CCRC16()));
    }
    void Hash_JPEG_CRC32(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CCRC32()));
    }
    void Hash_JPEG_CRC64(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CCRC64()));
    }
    void Hash_JPEG_XOr(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CXOR()));
    }
    void Hash_JPEG_Hash(){
        VerifyResult(BuildPacker(new HeaderBuilder::ValidationHeader::CHash(),new PacketBuilder::Compressor::CJPEG(),new HeaderBuilder::ValidationHeader::CHash()));
    }
